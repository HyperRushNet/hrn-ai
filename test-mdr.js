 ...
 * Een zelfstandige bibliotheek met ingebouwde styling.
 * 
 * Vereist (externe scripts in HTML head):
 * - marked.js
 * - katex.js + katex.auto-render
 * - prism.js
 */
...
`;
  ...
  // Parse inline content (basic markdown inline)
  ...
  function render(element, content) {
    ...
    if (content.markdown) {
      ...
      if (typeof marked !== 'undefined') {
        ...
        console.error('DarkAngel: marked.js is required for markdown rendering.');
        mdDiv.innerHTML += content.markdown;
      }
    }
    ...
    // Event Listeners for Task Lists
