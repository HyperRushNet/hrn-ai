class AIClient {
  constructor(options = {}) {
    // Het config object wordt nu gevuld met de meegegeven opties of de standaardwaarden
    this.config = {
  ...
  // De setter methodes zijn behouden voor flexibiliteit (chainable)
...
// --- Voorbeeld van gebruik (zoals gevraagd) ---

// Zorg dat process.env beschikbaar is of definieer de key handmatig voor de test
const process = { env: { AI_API_KEY: 'jouw-api-key-hier' } };
...
// Async functie om de generate aan te roepen
    const result = await client.generate('Explain how AIClient works');
    console.log(result);
  } catch (err) {
